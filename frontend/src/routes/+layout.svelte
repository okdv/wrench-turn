...
<div class="flex justify-between p-2 m-2 border-2 border-blue-500 rounded-md">
	...
	<div class="flex justify-around bg-white space-x-1">
		<a href="/users" class="p-2 rounded-md transition-transform duration-200 hover:scale-110"
			>Users</a
		>
		<a href="/jobs" class="p-2 rounded-md transition-transform duration-200 hover:scale-110">Jobs</a
		>
		<a href="/vehicles" class="p-2 rounded-md transition-transform duration-200 hover:scale-110"
			>Vehicles</a
		>
		{#if isLoggedIn}
